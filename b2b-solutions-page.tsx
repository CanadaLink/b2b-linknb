...
const services = [
  ...
  },
  {
    ...
    categories: ["development"],
    benefits: ["Bespoke solutions", "Agile development", "Ongoing support"],
  },
  {
    id: 10,
    title: "Performance Optimization",
    description: "Enhance your systems' performance for better efficiency and user experience.",
    icon: <Zap className="h-10 w-10" />,
    categories: ["development", "customer-success"],
    benefits: ["Speed improvements", "Resource efficiency", "User experience"],
  },
  {
    id: 11,
    ...
    categories: ["analytics"],
    benefits: ["Data visualization", "Predictive analytics", "Strategic insights"],
  },
  {
    id: 12,
    ...
    categories: ["marketing"],
    benefits: ["Brand differentiation", "Market positioning", "Audience engagement"],
  },
]
...
export default function B2BSolutionsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative bg-[#000000] text-white py-32 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute -bottom-24 -right-24 w-96 h-96 rounded-full bg-[#D32927] blur-3xl"
          />
          ...
          <motion.div
            ...
            className="absolute top-20 -left-24 w-96 h-96 rounded-full bg-[#F4C600] blur-3xl"
          />
          ...
          <motion.div
            ...
            className="absolute bottom-20 left-1/2 w-96 h-96 rounded-full bg-[#1A3C86] blur-3xl"
          />
        </div>
      ...
      <section
        ref={categoryRef}
        className="py-12 bg-white border-b border-gray-100 sticky top-0 z-20 backdrop-blur-lg bg-white/90"
      >
                    ...
                    <div className={isGridView ? "" : "flex-grow"}>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {service.categories.map((categoryId) => {
                          ...
                          const bgColor = `bg-[${getCategoryColor(categoryId)}]/10`
                          const textColor = `text-[${getCategoryColor(categoryId)}]`
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-gray-600">
              Our solutions have helped companies across industries achieve remarkable results.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="text-[#D32927] font-bold text-5xl mb-2">98%</div>
              <div className="text-gray-600">Client Retention Rate</div>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="text-[#1A3C86] font-bold text-5xl mb-2">500+</div>
              <div className="text-gray-600">Enterprise Clients</div>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="text-[#F4C600] font-bold text-5xl mb-2">35%</div>
              <div className="text-gray-600">Average ROI Increase</div>
            </motion.div>

            <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-xl shadow-sm text-center">
              <div className="text-[#000000] font-bold text-5xl mb-2">24/7</div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#000000] to-[#1A3C86] relative overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 w-96 h-96 rounded-full bg-[#D32927] blur-3xl opacity-20"
        />
