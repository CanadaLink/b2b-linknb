...
export default function SimplifiedWhyChooseUs() {
  return (
    <section className="py-12 md:py-24 bg-gray-50" id="why-choose-us">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-8 mb-10 md:mb-12">
          {[
            { value: "500+", label: "Enterprise Clients", color: "#D32927" },
            { value: "24/7", label: "Global Support", color: "#1A3C86" },
            { value: "10+", label: "Years Experience", color: "#F4C600" },
            { value: "100%", label: "NB Owned & Operated", color: "#000000" },
          ].map((stat, index) => (
        ...
        <div className="text-center">
          <Button asChild className="bg-[#1a3c86] hover:bg-[#1a3c86]/90 text-white font-medium">
