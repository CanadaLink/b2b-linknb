    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h3 className="text-xl font-bold">{industry.name} Solutions</h3>
      ...
      <div>
        ...
        <div className="relative overflow-hidden rounded-lg aspect-video bg-gray-100 mb-6">
          <img
            src="/logo.png"
            alt={`${industry.name} solution visualization`}
            className="w-full h-full object-contain p-4"
          />
        </div>

        <Button className="w-full bg-[#D32927] hover:bg-[#D32927]/90 text-white font-medium py-5 h-auto" asChild>
          <Link href="/meet">
              ...
              <DialogTrigger asChild>
                <motion.div
                  ...
                  className={cn(
                    ...
                    hoveredIndustry === industry.id ? "border-[#D32927]" : "",
                  )}
                >
                  <div
                  ...
                  <div className="text-[#D32927] hover:text-[#D32927]/80 text-sm font-medium flex items-center">
                    View Solutions
              ...
              <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription className="sr-only">
                    Detailed information about our solutions for the {industry.name} industry
                  </DialogDescription>
                </DialogHeader>
